...
$sql = "SELECT id, kullanici_adi, email FROM kullanicilar";
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin-konular.php">Konu Sil</a>
                </li>
                <li class="nav-item">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo '<td>
                                    <form method="POST" action="uyesil.php">
                                        <input type="hidden" name="user_id" value="' . $row["id"] . '">
                                        <button type="submit" class="btn btn-primary">Üye Çıkar</button>
                                    </form>
                                  </td>';
                            echo "</tr>";
                        }
