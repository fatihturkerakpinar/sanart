...
?>
        <section class="container mt-4">
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a href="odev-konu1.php"
                        class="page-link">1</a></li>
                <li class="page-item"><a href="odev-konu2.php"
                        class="page-link">2</a></li>
                <li class="page-item"><a href="odev-konu3.php"
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            geriLink.addEventListener("click", function () {
                if (simdikiSayfa > 1) {
                    simdikiSayfa--;
                    window.location.href = "odev-konu" + simdikiSayfa + ".php";
                }
            });
