...
?>
        <section class="container mt-4">
            ...
            <div class="baslik">
                <h1>Oppenheimer filminin alt metni <a href="#"
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a href="odev-konu1-page1.php"
                        class="page-link">1</a></li>
                <li class="page-item"><a href="odev-konu1-page2.php"
                        class="page-link">2</a></li>
                <li class="page-item"><a href="odev-konu1-page3.php"
            ...
            <div  id="mesajListesi">
                    ...
                    <div class="mesaj-icerik">
                        <p>Oppenheimer filmine gittim ve bence filmde arka planda bize anlatılmak istenen başka bir şey var...</p>
                        <div>
                            <a href="#"
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            geriLink.addEventListener("click", function () {
                if (simdikiSayfa > 1) {
                    simdikiSayfa--;
                    window.location.href = "odev-konu1-page" + simdikiSayfa + ".php";
                }
            });
