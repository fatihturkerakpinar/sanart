...
?>
        <section class="container mt-4">
            ...
            <div class="baslik">
                <h1>Haluk Bilginer'in Muhteşem KRAL LEAR Performansı <a href="#"
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a href="odev-konu2-page1.php"
                        class="page-link">1</a></li>
                <li class="page-item"><a href="odev-konu2-page2.php"
                        class="page-link">2</a></li>
                <li class="page-item"><a href="odev-konu2-page3.php"
            ...
            <div class="mesaj-listesi" id="mesajListesi">
                <div class="mesaj">
                    ...
                    <div class="mesaj-icerik">
                        <p>En büyük o mu bilmiyorum ama çok büyük</p>
                        <div>
                            <a href="#"
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            geriLink.addEventListener("click", function () {
                if (simdikiSayfa > 1) {
                    ...
                    simdikiSayfa--;
                    window.location.href = "odev-konu2-page" + simdikiSayfa + ".php";
                }
            });
